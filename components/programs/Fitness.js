                ...
                <ul className={`${Lang === "ar" ? styles.ar : ""}`}>
                  <li>
                    <p>
                      ...
                      <span>{t("programs.fitness.line1_2")}</span>{" "}
                  ...
                  <li>
                    <p>
                      ...
                      <span>{t("programs.fitness.line2_3")}</span>{" "}
                  ...
                  <li>
                    <p>
                      ...
                      <span>{t("programs.fitness.line3_2")}</span>{" "}
                  ...
                  <li>
                    <p>
                      ...
                      <span>{t("programs.fitness.line5_2")}</span>{" "}
