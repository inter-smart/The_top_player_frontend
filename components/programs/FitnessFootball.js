              ...
              <div className={styles.cntWrap}>
                ...
                <div className={styles.list_bx}>
                  <ul>
                    ...
                    <li>
                      <p>
                        {t("programs.fitness_fottboll.line3_1")}{" "}
                        <span>{t("programs.fitness_fottboll.line3_2")}</span>{" "}
                        {t("programs.fitness_fottboll.line3_3")}
                      </p>
                    </li>
                    <li>
                    ...
                    <li>
                      <p>
                        {t("programs.fitness_fottboll.line5_1")}{" "}
                        <span>{t("programs.fitness_fottboll.line5_2")}</span>{" "}
                        {t("programs.fitness_fottboll.line5_3")}
                      </p>
                    </li>
                  </ul>
                </div>
            ...
            <ul>
              <li>
                <div className={styles.check}>
                  ...
                  <p>fgfdh {t("programs_details.fitness_fottboll.line1")}</p>
                </div>
              </li>
              <li>
                <div className={styles.check}>
